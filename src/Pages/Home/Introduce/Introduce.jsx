...
const Introduce = () => {
  return (
    <section className="mt-32">
      <h4 className="uppercase text-center text-white text-2xl md:text-4xl">
        Let me <span className="primary-text">introduce</span>myself
      </h4>
      ...
      <div className="text-center mt-12 text-white">
        ...
        <p className="text-lg">
          Feel free to <span className="primary-text">connect</span> with me
        </p>
        <div className="flex justify-center items-center">
          <ul className="flex justify-center items-center gap-8 mt-8">
            <li className="bg-white rounded-full w-10 h-10 flex justify-center items-center primary-text text-2xl home-social-icons">
              <Link to="https://github.com/Sakibahmed2">
                {" "}
                <AiFillGithub />{" "}
              </Link>
            </li>
            <li className="bg-white rounded-full w-10 h-10 flex justify-center items-center primary-text text-2xl home-social-icons">
              <Link to="https://www.linkedin.com/in/sakib-ahmed-loskor/">
                {" "}
                <FaLinkedinIn />{" "}
              </Link>
            </li>
            <li className="bg-white rounded-full w-10 h-10 flex justify-center items-center primary-text text-2xl home-social-icons">
              <Link to="https://www.instagram.com/sakib_ahmed_47/">
                {" "}
                <AiFillInstagram />{" "}
              </Link>
            </li>
